(function(root, factory) {
    ...
    var DHDevice = (function() {
         ...
         * @paaram {String} accessKeyOrDeviceKey - Access key or device key (device key is deprecated) used for auth
         * @param {Boolean} forceDeviceKeyAuth - Force using the third parameter as a device kevice key
         */
